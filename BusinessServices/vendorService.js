        ...
        .then((user_from_store) => {
            ...
            return invokeChainCode.invokeChainCode(fabric_client, 
                ...
                [ 
                    ...
                    salesOrder.purchaserContactPerson,
                    salesOrder.purchaserContactAdd,
                    salesOrder.purchaserContactPhone,
                    salesOrder.purchaserContactEmail,
        ...
        .then((user_from_store) => {
            ...
            return invokeChainCode.invokeChainCode(fabric_client, 
                ...
                [ 
                    ...
                    orderedMaterial,
                    salesOrder.logisticsConsignmentNum,
                    new Date().toString()
                ]                
            );                
        }).then((results) => {
