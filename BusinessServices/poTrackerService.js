                        ...
                        .then((result) => {
                            ...
                            .then((result) => {
                                if(result.goodsReceipts != undefined && result.goodsReceipts.length > 0) {
                                    ...
                                    procurementService.getAllInspectionLotDetails("gr_number", poTrackerEntity.GoodsReceipts.goodsReceiptNumber)
                                        .then ((result) => {
                                            poTrackerEntity.InspectionLots = result.inspectionLots;
                                        });
                                }
                                else{
