        ...
        .then((user_from_store) => {
            ...
            return invokeChainCode.invokeChainCode(fabric_client, 
                ...
                [ 
                    ...
                    invoice.purchaserContactPerson,
                    invoice.purchaserContactAdd,
                    invoice.purchaserContactPhone,
                    invoice.purchaserContactEmail,
        ...
        .then((user_from_store) => {
            ...
            return invokeChainCode.invokeChainCode(fabric_client, 
                ...
                [ 
                    paymentProposal.paymentProposalNumber,
                    details,
                    paymentProposal.createdBy.toString()
                ]                
            );                
        }).then((results) => {
            return results;
